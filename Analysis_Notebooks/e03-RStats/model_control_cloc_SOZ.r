...
sink('PushPull_ControllerLoc_SOZ_Analysis.txt')
...
model1 <- lmer('Frac_Desync_SOZ ~ 1 + (1 | Subject_ID)', data=dat_sel, REML=FALSE)
model2 <- lmer('Frac_Desync_SOZ ~ 1 + Seizure_ID + (1 | Subject_ID)', data=dat_sel, REML=FALSE)
...
print('CType: Bulk')
model1 <- lmer('Frac_Bulk_SOZ ~ 1 + (1 | Subject_ID)', data=dat_sel, REML=FALSE)
model2 <- lmer('Frac_Bulk_SOZ ~ 1 + Seizure_ID + (1 | Subject_ID)', data=dat_sel, REML=FALSE)
print(anova(model1, model2))
print(model2)
print(r.squaredGLMM(model1))
print(r.squaredGLMM(model2))
...
print('CType: Sync')
model1 <- lmer('Frac_Sync_SOZ ~ 1 + (1 | Subject_ID)', data=dat_sel, REML=FALSE)
model2 <- lmer('Frac_Sync_SOZ ~ 1 + Seizure_ID + (1 | Subject_ID)', data=dat_sel, REML=FALSE)
print(anova(model1, model2))
print(model2)
print(r.squaredGLMM(model1))
print(r.squaredGLMM(model2))
